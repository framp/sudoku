...
var _user$project$State$select = F3(
...
var _user$project$State$removeHint = F2(
...
var _user$project$State$insertHint = F2(
	function (number, cell) {
		return _elm_lang$core$Native_Utils.update(
			cell,
			{
...
var _user$project$State$init = {
	ctor: '_Tuple2',
	_0: {
		board: _user$project$Model$toBoard(_user$project$Model$heart),
		select: false
	},
						...
						model,
						{
							board: _user$project$Model$validateBoard(
								A3(
									_user$project$State$transformElement,
									_p1,
									A2(_user$project$State$select, _p1, _p0._0),
									model.board))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Deselect':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							board: _user$project$Model$validateBoard(
								A3(_user$project$State$transformElement, _p0._0, _user$project$State$deselect, model.board))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Clear':
