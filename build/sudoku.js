...
var _user$project$Model$validateBoard = function (board) {
	var inSet = F3(
		function (indexTransform, _p0, board) {
			var _p1 = _p0;
			var _p3 = _p1._0;
			return A2(
				_elm_lang$core$List$member,
				A2(_elm_lang$core$Maybe$withDefault, 0, _p1._1.selected),
				A2(
					_elm_lang$core$List$map,
					function (_p2) {
						return A2(
							...
							A2(
								...
								A2(
									...
									A3(_elm_lang$core$Basics$flip, _elm_lang$core$Array$get, board, _p2))));
					},
					A2(
	...
	var updateValidity = function (_p8) {
		var _p9 = _p8;
		var _p11 = _p9._0;
		var _p10 = _p9._1;
		return A2(
...
var _user$project$Model$fromCell = function (_p12) {
	var _p13 = _p12;
	var _p14 = _p13.selected;
...
var _user$project$Model$toBoard = function (_p16) {
	return _user$project$Model$validateBoard(
		A2(_elm_lang$core$Array$map, _user$project$Model$toCell, _p16));
};
...
var _user$project$State$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: {
			board: _user$project$Model$toBoard(
				A2(_elm_lang$core$Maybe$withDefault, _user$project$Model$heart, flags)),
			select: false
		},
		...
		var saveGame = function (game) {
			return {
				...
				_1: _user$project$State$save(
					_user$project$Model$fromBoard(game.board))
			};
		};
...
var savedSudoku = null
try {
  savedSudoku = window.localStorage && window.localStorage.getItem('sudoku').split(',').map(function(a) { return Number(a) || 0 })
  if (savedSudoku.reduce(function(acc, v){ return acc+v }, 0) === 0) {
    savedSudoku = null
  }
} catch (e) {}
