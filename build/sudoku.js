...
var _user$project$Model$heart = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
		_0: 0,
		_1: {
...
var _user$project$Model$isEmptyBoard = function (board) {
	return A2(
		_elm_lang$core$List$all,
		function (_p0) {
			var _p1 = _p0;
			return _elm_lang$core$Native_Utils.eq(_p1.selected, _elm_lang$core$Maybe$Nothing);
		},
		_elm_lang$core$Array$toList(board));
};
var _user$project$Model$emptyBoard = A2(
	_elm_lang$core$Array$repeat,
	81,
	{hints: _elm_lang$core$Set$empty, selected: _elm_lang$core$Maybe$Nothing, valid: false});
var _user$project$Model$validateBoard = function (board) {
	var inSet = F3(
		function (indexTransform, _p2, board) {
			var _p3 = _p2;
			var _p5 = _p3._0;
			return A2(
				_elm_lang$core$List$member,
				A2(_elm_lang$core$Maybe$withDefault, 0, _p3._1.selected),
				A2(
					_elm_lang$core$List$map,
					function (_p4) {
						return A2(
							...
							A2(
								...
								A2(
									...
									A3(_elm_lang$core$Basics$flip, _elm_lang$core$Array$get, board, _p4))));
					},
					A2(
	...
	var indexToRegion = function (index) {
		return A2(
			_elm_lang$core$List$map,
			function (n) {
				return ((((((((index / 9) | 0) / 3) | 0) * 3) * 9) + (((A2(_elm_lang$core$Basics_ops['%'], index, 9) / 3) | 0) * 3)) + A2(_elm_lang$core$Basics_ops['%'], n, 3)) + (((n / 3) | 0) * 9);
			},
	...
	var indexToColumn = function (index) {
		return A2(
			_elm_lang$core$List$map,
			function (n) {
				return A2(_elm_lang$core$Basics_ops['%'], index, 9) + (9 * n);
			},
			A2(_elm_lang$core$List$range, 0, 8));
	};
	...
	var updateValidity = function (_p10) {
		var _p11 = _p10;
		var _p13 = _p11._0;
		var _p12 = _p11._1;
		return A2(
...
var _user$project$Model$cellEncoder = function (_p14) {
	var _p15 = _p14;
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				...
				_0: 'selected',
				_1: function () {
					var _p16 = _p15.selected;
					if (_p16.ctor === 'Nothing') {
						return _elm_lang$core$Json_Encode$null;
					} else {
						return _elm_lang$core$Json_Encode$int(_p16._0);
					}
				}()
			},
			_1: {
				...
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$list(
						A2(
							...
							_elm_lang$core$Set$toList(_p15.hints)))
				},
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Model$boardEncoder = function (board) {
	return _elm_lang$core$Json_Encode$array(
		A2(_elm_lang$core$Array$map, _user$project$Model$cellEncoder, board));
};
var _user$project$Model$encodeBoard = function (board) {
	return A2(
		_elm_lang$core$Json_Encode$encode,
		0,
		_user$project$Model$boardEncoder(board));
};
var _user$project$Model$set = function (decoder) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (_p17) {
			return _elm_lang$core$Json_Decode$succeed(
				_elm_lang$core$Set$fromList(_p17));
		},
		_elm_lang$core$Json_Decode$list(decoder));
};
var _user$project$Model$fromCell = function (_p18) {
	var _p19 = _p18;
	var _p20 = _p19.selected;
...
var _user$project$Model$fromBoard = _elm_lang$core$Array$map(_user$project$Model$fromCell);
var _user$project$Model$toCell = function (number) {
	return {
		hints: _elm_lang$core$Set$empty,
		selected: function () {
			var _p21 = number;
			if (_p21 === 0) {
				return _elm_lang$core$Maybe$Nothing;
...
var _user$project$Model$toBoard = function (_p22) {
	return _user$project$Model$validateBoard(
		A2(_elm_lang$core$Array$map, _user$project$Model$toCell, _p22));
};
var _user$project$Model$Game = F2(
	function (a, b) {
		return {board: a, select: b};
	});
var _user$project$Model$Cell = F3(
	function (a, b, c) {
		return {selected: a, hints: b, valid: c};
	});
var _user$project$Model$cellDecoder = A2(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$hardcoded,
	true,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'hints',
		_user$project$Model$set(_elm_lang$core$Json_Decode$int),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'selected',
			_elm_lang$core$Json_Decode$nullable(_elm_lang$core$Json_Decode$int),
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$Cell))));
var _user$project$Model$boardDecoder = _elm_lang$core$Json_Decode$array(_user$project$Model$cellDecoder);
var _user$project$Model$decodeBoard = _elm_lang$core$Json_Decode$decodeString(_user$project$Model$boardDecoder);
var _user$project$Model$Solutions = function (a) {
	return {ctor: 'Solutions', _0: a};
};
var _user$project$Model$Clear = {ctor: 'Clear'};
var _user$project$Model$SelectToggle = {ctor: 'SelectToggle'};
var _user$project$Model$Solve = {ctor: 'Solve'};
var _user$project$Model$Deselect = function (a) {
	return {ctor: 'Deselect', _0: a};
};
var _user$project$Model$Select = F2(
	function (a, b) {
		return {ctor: 'Select', _0: a, _1: b};
	});
var _user$project$Model$RemoveHint = F2(
	function (a, b) {
		return {ctor: 'RemoveHint', _0: a, _1: b};
	});
var _user$project$Model$InsertHint = F2(
	function (a, b) {
		return {ctor: 'InsertHint', _0: a, _1: b};
	});

var _user$project$State$init = function (flags) {
	var heartBoard = _user$project$Model$toBoard(_user$project$Model$heart);
	var savedBoard = A2(
		_elm_lang$core$Result$withDefault,
		heartBoard,
		_user$project$Model$decodeBoard(flags));
...
var _user$project$State$save = _elm_lang$core$Native_Platform.outgoingPort(
	'save',
	function (v) {
		return v;
	});
	...
	function (msg, model) {
		var saveGame = function (game) {
			return {
				ctor: '_Tuple2',
				_0: game,
				_1: _user$project$State$save(
					_user$project$Model$encodeBoard(game.board))
			};
		};
		var transformElement = F3(
			function (index, transform, array) {
				return A2(
					...
					A2(
						_elm_lang$core$Maybe$map,
						function (val) {
							return A3(_elm_lang$core$Array$set, index, val, array);
						},
						A2(
							_elm_lang$core$Maybe$map,
							transform,
		...
		var deselect = function (cell) {
			return _elm_lang$core$Native_Utils.update(
				cell,
				{selected: _elm_lang$core$Maybe$Nothing});
		};
		var select = F3(
			function (index, number, cell) {
				return _elm_lang$core$Native_Utils.update(
					cell,
					{
						selected: _elm_lang$core$Maybe$Just(number)
					});
			});
		var removeHint = F2(
			function (number, cell) {
				return _elm_lang$core$Native_Utils.update(
					cell,
					{
						hints: A2(_elm_lang$core$Set$remove, number, cell.hints)
					});
			});
		var insertHint = F2(
			function (number, cell) {
				return _elm_lang$core$Native_Utils.update(
					cell,
					{
						hints: A2(_elm_lang$core$Set$insert, number, cell.hints)
					});
			});
		var _p0 = msg;
		switch (_p0.ctor) {
			...
			case 'Select':
				...
				return saveGame(
					_elm_lang$core$Native_Utils.update(
						model,
						{
							board: _user$project$Model$validateBoard(
								A3(
									transformElement,
									_p1,
									A2(select, _p1, _p0._0),
									model.board))
						}));
			case 'Deselect':
				return saveGame(
					_elm_lang$core$Native_Utils.update(
						...
						{
							board: _user$project$Model$validateBoard(
								A3(transformElement, _p0._0, deselect, model.board))
						}));
			case 'Clear':
				return saveGame(
					_elm_lang$core$Native_Utils.update(
			...
			case 'Solve':
				return {
					...
					_1: _user$project$State$solve(
						_user$project$Model$fromBoard(model.board))
				};
			case 'SelectToggle':
				return {
					ctor: '_Tuple2',
				...
				if ((_p0._0.ctor === '::') && (_p0._0._1.ctor === '[]')) {
					return saveGame(
						_elm_lang$core$Native_Utils.update(
							model,
							{
								board: _user$project$Model$toBoard(_p0._0._0)
							}));
				} else {
...
var _user$project$State$solutions = _elm_lang$core$Native_Platform.incomingPort(
	'solutions',
...
var _user$project$State$subscriptions = function (model) {
	return _user$project$State$solutions(_user$project$Model$Solutions);
};
...
var _user$project$View$viewHint = F4(
	function (selectMode, cellIndex, hints, hint) {
		...
		var action = selectMode ? A2(_user$project$Model$Select, hint, cellIndex) : (selected ? A2(_user$project$Model$RemoveHint, hint, cellIndex) : A2(_user$project$Model$InsertHint, hint, cellIndex));
		return A2(
			...
			},
			{
				...
				_0: _elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(hint)),
				_1: {ctor: '[]'}
			});
	});
				...
				_elm_lang$core$List$concat(
					{
						...
						_0: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(
								_p1.valid ? 'cell filled-cell' : 'cell filled-cell invalid'),
							_1: {ctor: '[]'}
						},
						_1: {
							ctor: '::',
							_0: selectMode ? {
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Model$Deselect(index)),
								_1: {ctor: '[]'}
							} : {ctor: '[]'},
							_1: {ctor: '[]'}
						}
...
var _user$project$App$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$State$init, update: _user$project$State$update, subscriptions: _user$project$State$subscriptions, view: _user$project$View$view})(_elm_lang$core$Json_Decode$string);
...
var savedSudoku = window.localStorage && window.localStorage.getItem('sudoku') || ''
var sudokuSolver = new SudokuSolver()
var app = Elm.App.fullscreen(savedSudoku)
...
app.ports.save.subscribe(function(puzzle) {
  window.localStorage && window.localStorage.setItem('sudoku', puzzle)
})